...
To answer this, they surveyed huundreds of commuters, collecting data on:
...
where $p_i$ is the predicted probability for individual $i$ and $psilon_i$ is the error term.
